...
#[inline(always)]
pub const fn mulhi(x: u128, y: u128) -> u128 {
    const MASK: u128 = u64::MAX as u128;
    const SHIFT: i32 = u64::BITS as i32;
    ...
    let w0 = x0 * y0;
    let m = (x0 * y1) + (w0 >> SHIFT);
    let w1 = m & MASK;
    let w2 = m >> SHIFT;

    let w3 = (x1 * y0 + w1) >> SHIFT;
...
#[inline]
#[allow(clippy::many_single_char_names)] // reason="mathematical names"
pub const fn moderate_u128_divrem(n: u128, d: u64, factor: u128, factor_shr: u32) -> (u128, u64) {
    let quot = mulhi(n, factor) >> factor_shr;
    let rem = (n - quot * d as u128) as u64;
    (quot, rem)
}
...
#[inline]
#[allow(clippy::many_single_char_names)] // reason="mathematical names"
pub const fn slow_u128_divrem(n: u128, d: u64, d_ctlz: u32) -> (u128, u64) {
    // Ensure we have the correct number of leading zeros passed.
    debug_assert!(d_ctlz == d.leading_zeros());
...
#[inline(always)]
pub const fn u128_divrem(n: u128, radix: u32) -> (u128, u64) {
    return match radix {
        2 => u128_divrem_2(n),
        3 => u128_divrem_3(n),
        4 => u128_divrem_4(n),
        ...
        35 => u128_divrem_35(n),
        36 => u128_divrem_36(n),
        _ => panic!("Only radices from 2 to 36 should be provided."),
    };
}
...
#[inline(always)]
const fn u128_divrem_3(n: u128) -> (u128, u64) {
...
#[inline(always)]
const fn u128_divrem_7(n: u128) -> (u128, u64) {
...
#[inline(always)]
const fn u128_divrem_9(n: u128) -> (u128, u64) {
    slow_u128_divrem(n, 12157665459056928801, 0)
}

#[inline(always)]
const fn u128_divrem_10(n: u128) -> (u128, u64) {
    fast_u128_divrem(
        n,
...
#[inline(always)]
const fn u128_divrem_15(n: u128) -> (u128, u64) {
...
#[inline(always)]
const fn u128_divrem_27(n: u128) -> (u128, u64) {
    slow_u128_divrem(n, 4052555153018976267, 2)
}

#[inline(always)]
const fn u128_divrem_28(n: u128) -> (u128, u64) {
    fast_u128_divrem(
        n,
        6502111422497947648,
...
#[inline(always)]
const fn u128_divrem_33(n: u128) -> (u128, u64) {
    slow_u128_divrem(n, 1667889514952984961, 3)
}

#[inline(always)]
const fn u128_divrem_34(n: u128) -> (u128, u64) {
    fast_u128_divrem(
        n,
        2386420683693101056,
